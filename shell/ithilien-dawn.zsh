...
_ITHILIEN_FZF_COLORS='--color=light,bg:#FAFAF8,fg:#000000,bg+:#B8595C,fg+:#000000,hl:#000000:underline,hl+:#000000:underline,info:#000000,header:#000000,border:#505456,prompt:#8B3037,pointer:#000000,marker:#000000,spinner:#8B3037,gutter:#FAFAF8,query:#000000'
