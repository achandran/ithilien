...
zle_highlight=("${(@)zle_highlight:#region:*}" "region:bg=#9FA9A4,fg=#000000")
...
_ITHILIEN_FZF_COLORS='--color=light,bg:#FAFAF8,fg:#000000,bg+:#9FA9A4,fg+:#000000,hl:#000000:underline,hl+:#000000:underline,info:#000000,header:#000000,border:#505456,prompt:#AD2F38,pointer:#000000,marker:#000000,spinner:#AD2F38,gutter:#FAFAF8,query:#000000'
