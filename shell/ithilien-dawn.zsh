...
zle_highlight=("${(@)zle_highlight:#region:*}" "region:bg=#C4CAC8,fg=#000000")
...
_ITHILIEN_FZF_COLORS='--color=light,bg:#F6F6F3,fg:#000000,bg+:#C4CAC8,fg+:#000000,hl:#000000:underline,hl+:#000000:underline,info:#000000,header:#000000,border:#596166,prompt:#A3373E,pointer:#000000,marker:#000000,spinner:#A3373E,gutter:#F6F6F3,query:#000000'
