...
for i,(spray,amber,ash) in enumerate(itertools.product(['#E0E9EE','#D7E3EA','#D2DFE7'],['#D8B46A','#D0A859'],['#596166','#51595E'])):
 ...
 metrics={'comment_contrast':wcag(ash,base[source['backgrounds']['base']]),'inline_text_contrast':wcag('#000000',amber),'line_delta_e':Color(spray).delta_e(base[source['backgrounds']['base']],method='2000'),'inline_delta_e':Color(amber).delta_e(spray,method='2000'),'search_delta_e':Color(amber).delta_e(base[source['backgrounds']['search']],method='2000')}
