...
from tintprobe.context import ROOT, load_palette, port_path


def check(recording, theme=None):
    ...
    theme_path = ROOT / 'extras/codex/themes' / (theme + '.tmTheme') if theme else port_path('codex_theme')
    ...
    report = assess(json.loads(recording.read_text()), load_palette(theme))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--theme', choices=('ithilien-dawn', 'ithilien-dusk'))
    args = parser.parse_args()
    report = check(args.recording, args.theme)
