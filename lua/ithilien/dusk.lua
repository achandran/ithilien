...
function M.load(opts)
  ...
  Identifier={fg=p.fg}, Function={fg=p.fg}, Type={fg=p.fg,bold=opts.bold},
  Statement={fg=p.fg,bold=opts.bold}, Special={fg=p.blue}, Constant={fg=p.fg}, Number={fg=p.fg}, Boolean={fg=p.fg},
