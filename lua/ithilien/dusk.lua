...
function M.load(opts)
  ...
  local raw = require('ithilien.ithilien-dusk').raw
  ...
  local p = { bg=bg.base, surface=bg.mantle, line=bg.surface1, raised=bg.surface0,
   ...
   ansi=require('ithilien.ithilien-dusk').terminal }
  local palette = require('ithilien.ithilien-dusk')
  ...
  String={fg=a.sage,italic=config.italic_strings == true},
  ...
  Identifier={fg=p.fg}, Function={fg=p.fg}, Type={fg=a.aqua,bold=opts.bold},
  Statement={fg=a.clay,bold=opts.bold}, Special={fg=p.blue}, Constant={fg=a.ochre}, Number={fg=a.ochre}, Boolean={fg=a.ochre},
  LineNr={fg=p.muted}, CursorLineNr={fg=p.fg,bold=true}, CursorLine={bg=p.line},
  EndOfBuffer={fg=p.muted}, SignColumn={bg=p.bg}, NonText={fg=p.border}, Whitespace={fg=p.border},
  WinSeparator={fg=p.border}, Visual={fg=raw.highlight.foreground,bg=p.selection},
  VisualNOS={link="Visual"},
  Search={fg=highlight.foreground,bg=p.search}, IncSearch={fg=highlight.foreground,bg=p.search,bold=true,underline=true},
  CurSearch={fg=highlight.foreground,bg=p.search,bold=true,underline=true},
  ...
  DiffChange={fg=p.fg,bg=p.change},DiffText={fg=diff.inlineForeground,bg=p.change_emph},
  ...
  GitSignsAddInline={fg=diff.inlineForeground,bg=p.add_emph},
  GitSignsChangeInline={fg=diff.inlineForeground,bg=p.change_emph},
  GitSignsDeleteInline={fg=diff.inlineForeground,bg=p.delete_emph},
  ...
  for _,name in ipairs({'Substitute','SnacksPickerPickWin','MiniTablineTabpagesection',
   'SnacksPickerListCursorLine','TelescopeSelection','BlinkCmpMenuSelection'}) do
   groups[name]={fg=highlight.foreground,bg=highlight.background}
  end
  for _,name in ipairs({'GitConflictCurrent','GitConflictIncoming'}) do
   groups[name]={fg=diff.conflictForeground,bg=diff.conflictBackground}
  end
  groups.GitConflictAncestor={fg=diff.hunkForeground,bg=diff.hunkBackground}
  for group, spec in pairs(groups) do hi(group,spec) end
  -- Keep structural and supporting foregrounds readable on raised surfaces.
  ...
  -- Deliberate plugin semantics, applied after the base highlights.
  ...
  hi('LspSignatureActiveParameter',{fg=highlight.foreground,bg=p.search,bold=true})
