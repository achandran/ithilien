...
| Rosehip | `#A3373E` | Fruit of Ithilien’s wild roses; deep red. [Source](https://tolkiengateway.net/wiki/Ithilien) | `accents.coral`, `ansi.brightRed`, `ansi.extendedClay` |
...
| Lily | `#FDFDFA` | Lilies in Ithilien; pale petals. [Source](https://tolkiengateway.net/wiki/Ithilien) | `backgrounds.surface0`, `ansi.brightWhite` |
| Anemone | `#ECEEEB` | White anemones in Ithilien; warm off-white. [Source](https://tolkiengateway.net/wiki/Anemones) | `backgrounds.surface1` |
| Osgiliath | `#D6DCD9` | City straddling Anduin at Ithilien’s western edge; weathered stone. [Source](https://tolkiengateway.net/wiki/Osgiliath) | `backgrounds.crust` |
